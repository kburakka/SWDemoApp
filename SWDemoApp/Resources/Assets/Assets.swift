...
public enum Asset {
  ...
  public enum Images {
    ...
    public static let imgBedroomWhite = ImageAsset(name: "imgBedroomWhite")
    public static let imgClothes = ImageAsset(name: "imgClothes")
    public static let imgClothesWhite = ImageAsset(name: "imgClothesWhite")
    public static let imgDevices = ImageAsset(name: "imgDevices")
    public static let imgDevicesWhite = ImageAsset(name: "imgDevicesWhite")
    public static let imgElectrical = ImageAsset(name: "imgElectrical")
    public static let imgElectricalWhite = ImageAsset(name: "imgElectricalWhite")
    public static let imgFirstaid = ImageAsset(name: "imgFirstaid")
    public static let imgFirstaidWhite = ImageAsset(name: "imgFirstaidWhite")
    public static let imgGadget = ImageAsset(name: "imgGadget")
    public static let imgGadgetWhite = ImageAsset(name: "imgGadgetWhite")
    public static let imgXmlid = ImageAsset(name: "imgXmlid")
    public static let imgXmlidWhite = ImageAsset(name: "imgXmlidWhite")
