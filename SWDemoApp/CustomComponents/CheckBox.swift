...
open class CheckBox: UIControl {
    ...
    var uncheckedBorderColor: UIColor = .appShaft
    
    var checkedBorderColor: UIColor = .appShaft
    
    var checkmarkColor: UIColor = .appShaft
    ...
    open override func draw(_ rect: CGRect) {
        ...
        shapePath = UIBezierPath(roundedRect: newRect, cornerRadius: 5)
